...
export const Hero: React.FC<HeroProps> = ({ onOpenDashboard }) => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-slate-50/50 to-white pt-12 pb-20 md:pt-20 md:pb-28 border-b border-slate-100">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-sky-100/40 rounded-full blur-3xl -z-10 pointer-events-none" />
      <div className="absolute -top-24 right-0 w-[400px] h-[400px] bg-blue-100/30 rounded-full blur-2xl -z-10 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* STEM / TVET Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1B4F72]/10 text-[#1B4F72] text-xs sm:text-sm font-semibold border border-[#1B4F72]/20 shadow-2xs">
              <Sparkles className="w-4 h-4 text-[#2874A6]" />
              <span>STEM және TVET білім беру бағдарламасы</span>
            </div>

            {/* Main Title */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.15]">
              <span className="block text-[#1B4F72]">Атом физикасы</span>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1 text-xs text-slate-500 font-medium">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white rounded-md border border-slate-200 text-slate-700 shadow-2xs">
                <GraduationCap className="w-4 h-4 text-[#1B4F72]" />
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
              <a
                id="hero-about-btn"
                href="#about"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#1B4F72] hover:bg-[#2874A6] text-white font-semibold text-base shadow-md shadow-[#1B4F72]/20 hover:shadow-lg transition-all duration-200 cursor-pointer group"
              >
            ...
            <div className="relative w-full max-w-md bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/90 shadow-xl shadow-slate-200/50 space-y-6">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-[#1B4F72] text-white flex items-center justify-center font-bold text-lg">
                    ⚛
                  </div>
                  <div>
              ...
              <div className="relative py-6 bg-gradient-to-br from-[#1B4F72] to-[#2874A6] rounded-xl text-white p-6 overflow-hidden shadow-inner">
                <div className="absolute right-[-20px] -bottom-10 opacity-10 text-9xl font-black select-none pointer-events-none">
                  E=mc²
                </div>
                <div className="relative z-10 space-y-3">
                  <span className="text-xs font-semibold text-sky-200 uppercase tracking-widest">Ғылыми негіз</span>
                  <p className="text-lg font-bold leading-snug">
                    Атомдар мен ядролар физикасын терең меңгеруге арналған
                  </p>
                  <div className="pt-2 flex items-center gap-4 text-xs text-sky-100">
              ...
              <div className="grid grid-cols-2 gap-3 text-left">
                <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                  <span className="block text-2xl font-black text-[#1B4F72]">6</span>
                  <span className="text-xs font-semibold text-slate-600">Негізгі бөлім</span>
                </div>
                <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                  <span className="block text-2xl font-black text-[#2874A6]">100%</span>
